                    ...
                    <div class="card-body">
                      <div class="row">
                       ...
                       <div class="show_supplier" style="display:none">
                        <form action="{{ route('supplier.wise.pdf') }}" target="_blank" method="get" id="myForm">
                            <div class="row">
                       ...
                       <div class="show_product" style="display: none;">
                        <form action="{{ route('product.wise.pdf') }}" target="_blank" method="get" id="myForm">
                            <div class="row">
...
<script type="text/javascript">
    ...
    $(document).ready(function (){
        $('#myForm').validate({
            ...
            messages : {
                supplier_id:{
                    required: 'Please Select Suplier ',
                },     
            },
            errorElement : 'span',
