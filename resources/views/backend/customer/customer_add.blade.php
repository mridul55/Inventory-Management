            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body ">
                        ...
                        <form action="{{ route('customer.store') }}" id="myForm" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-10">
                                    <input class="form-control" type="text"  required name="mobile_no" >
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="submit" class="btn btn-info" value="Add Customer Info">
                                </div>
                            </div>
                        </form>
