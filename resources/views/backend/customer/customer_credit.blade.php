    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                       <a href="{{ route('credit.customer.print.pdf') }}" target="_blank" class="btn btn-info btn-rounded waves-effect waves-light" style="float:right;"> <i class="fa fa-print"> </i>Print Credit Customer</a> <br><br>
                        <h4 class="card-title"> CXredit Customer All Data</h4>
