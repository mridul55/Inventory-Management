        ...
        <form method="post" action="{{ route('invoice.store') }}">
            ...
            <div class="form-row">
                <div class="form-group col-md-6 ">
                    <textarea maxlength="225" rows="3" name="description" id="description" class="form-control" placeholder="Right Description"></textarea>
                </div>
            </div><br>
            <div class="row">
            ...
            <div class="row new_customer" style="display: none">
                 ...
                 <div class="form-group col-md-4">
                    <input type="text" name="mobile_no" id="mobile_no" class="form-control" placeholder="Write customer Phone">
                 </div>
                 <div class="form-group col-md-4">
