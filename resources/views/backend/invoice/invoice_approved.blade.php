        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Invoice Approved</h4>
                ...
                <div class="card">
                    <div class="card-body">
                       ...
                       <table class="table table-dark" width="100%">
                        <tbody>
                            <tr>
                                ...
                                <td><p>Mobile Number:  <strong>{{ $payment->customer->mobile_no }}</strong></p></td>
                      ...
                      <form action="{{ route('approval.store',$invoice->id) }}" method="post">
                        ...
                        <button type="submit" class="btn btn-info">Invoice Approved</button>
                      </form>
