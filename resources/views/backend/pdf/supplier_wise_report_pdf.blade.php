                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Supplier Wise Stock Report Data</li>
                        </ol>
                    </div>
                                ...
                                <div class="invoice-title">
                                    ...
                                    <h3>
                                        <img src="{{ asset('backend/assets/images/logo-sm.png') }}"
                                            alt="logo" height="24" /> RDA Market Shopping Mall
                                    </h3>
                                </div>
                                <hr>
                                ...
                                <div>
                                    ...
                                    <div class="">
                                        <div class="table-responsive">
                                            {{-- {{ dd($allData[0]->supply->name) }} --}}
                                            <h3 class="text-center"><strong>Supplier Name:</strong>{{ $supplier->name }}</h3>
                                            <table class="table">
                                                <thead>
                                                    <tr>
